                ...
                <div className="backdrop-blur-xl bg-white/[0.04] border border-white/[0.08] rounded-3xl p-8 md:p-10 shadow-2xl">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            ...
                            type="submit"
                            disabled={loading}
                            className="w-full py-3.5 rounded-xl font-semibold text-sm tracking-wide font-Raleway transition-all duration-300 cursor-pointer relative overflow-hidden disabled:opacity-60 disabled:cursor-not-allowed"
                            style={{
                                background: loading
                                    ? "rgba(46,232,160,0.3)"
